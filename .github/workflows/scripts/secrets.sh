...
kubectl delete secret "$2" --namespace="$1" --ignore-not-found | kubectl create secret docker-registry "$2" --docker-server="$5" --docker-username="$3" --docker-password="$4" --namespace="$1"
